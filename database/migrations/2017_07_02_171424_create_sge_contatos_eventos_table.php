...
class CreateSgeContatosEventosTable extends Migration {
	...
	public function up()
	{
		Schema::create('contatos_eventos', function(Blueprint $table)
		{
			...
			$table->timestamps();
			$table->integer('salvoPor')->nullable()->index('fk_contatos_eventos_usuarios1_idx');
		});
	}
	...
	{
		Schema::drop('sge_contatos_eventos');
	}
