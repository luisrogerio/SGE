...
class AddForeignKeysToUsuariosTable extends Migration {
	...
	public function up()
	{
		Schema::table('usuarios', function(Blueprint $table)
		{
			...
			$table->foreign('idUsuariosGrupos', 'fk_usuarios_usuarios_grupos1')->references('id')->on('usuarios_grupos')->onUpdate('NO ACTION')->onDelete('NO ACTION');
	...
	public function down()
	{
		Schema::table('usuarios', function(Blueprint $table)
		{
			...
			$table->dropForeign('fk_usuarios_usuarios_grupos1');
