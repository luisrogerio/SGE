...
class AddForeignKeysToSgeEquipesUsuariosTable extends Migration {
	...
	public function up()
	{
		Schema::table('equipes_usuarios', function(Blueprint $table)
		{
			...
			$table->foreign('salvoPor', 'fk_equipes_usuarios_usuarios1')->references('id')->on('usuarios')->onUpdate('NO ACTION')->onDelete('NO ACTION');
		});
	}
	...
	public function down()
	{
		Schema::table('equipes_usuarios', function(Blueprint $table)
		{
			...
			$table->dropForeign('fk_equipes_usuarios_usuarios1');
		});
	}
