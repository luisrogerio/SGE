...
class AddForeignKeysToSgeEquipesTable extends Migration {
	...
	public function up()
	{
		Schema::table('equipes', function(Blueprint $table)
		{
			...
			$table->foreign('salvoPor', 'fk_equipes_usuarios1')->references('id')->on('usuarios')->onUpdate('NO ACTION')->onDelete('NO ACTION');
		});
	}
	...
	public function down()
	{
		Schema::table('equipes', function(Blueprint $table)
		{
			...
			$table->dropForeign('fk_equipes_usuarios1');
		});
	}
