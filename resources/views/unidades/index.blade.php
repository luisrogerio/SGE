...
@foreach($unidades as $unidade)
    <tr>
        ...
        <td class="text-center">
            ...
            <a class="btn btn-link" type='button' data-toggle="modal" data-target="#confirmDelete" data-title="Deletar Unidade" data-message='Você tem certeza que deseja deletar esse unidade?'>
