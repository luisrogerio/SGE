@extends('layouts.layout_admin') @section('title', 'Cursos') @section('content')
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <fieldset class="form-group">
            {{Form::label('sigla', 'Sigla') }} {{Form::text('sigla', null, array('class' => 'form-control', 'maxlength' => 10))}} @if
            ($errors->has('sigla'))
            <p class="help-block">{{$errors->first('sigla')}}</p> @endif
        </fieldset>
